package com.orangehrm.leave.applyleave;
...
public class ApplyLeave {
	...
	@Test(dataProvider = "applyLeaveData")
	public void applyLeave(String leaveTypeText, String fromDate,  String comments) throws InterruptedException {
		
		//Going to click on Tab Apply Leave
		String mainMenuXpath="//*[@id=\"app\"]/div[1]/div[1]/header/div[2]/nav/ul/li[1]/a";
		OrangeHRMUtility.navigateToMainMenu(driver, mainMenuXpath);
		
		//Leave Type
		OrangeHRMUtility.selectLeaveType(driver, leaveTypeText);
		//From Date
		driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[1]/div/div[2]/div/div/input")).sendKeys(fromDate);
		//To Date
